...
const variantStyles = {
  solid: {
    primary: "relative overflow-hidden bg-teal-500 text-white before:absolute before:inset-0 active:before:bg-transparent hover:before:bg-white/10 active:bg-teal-600 active:text-white/80 before:transition-colors",
  ...
  outline: {
    primary: "border-teal-500 text-teal-500 hover:border-teal-600 hover:bg-teal-500/10 active:bg-teal-500/20 active:text-teal-600/80",
    ...
    white: "border-white text-white hover:border-white/80 hover:bg-white/10 active:bg-white/20 active:text-white/80",
