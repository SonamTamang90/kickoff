...
const styles = {
  ...
  colors: {
    primary: [
      "text-white [--btn-bg:var(--color-primary-600)] [--btn-border:var(--color-primary-700)]/90 [--btn-hover-overlay:var(--color-white)]/10",
...
export const Button = forwardRef<HTMLElement, ButtonProps>(
  ({ color, outline, plain, className, children, ...props }, ref) => {
    const classes = clsx(
      className,
      styles.base,
      outline
