...
const variantStyles = {
  solid: {
    primary: "relative overflow-hidden bg-primary text-black before:absolute before:inset-0 active:before:bg-transparent hover:before:bg-black/10 active:bg-primary-500 active:text-black/80 before:transition-colors",
  ...
  outline: {
    primary: "border-primary text-primary hover:border-primary-500 hover:bg-primary/10 active:bg-primary/20 active:text-primary-500/80",
