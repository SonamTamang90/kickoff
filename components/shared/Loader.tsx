...
export const Loader = ({
  ...
  return (
    <div
      className={`fixed inset-0 w-full h-screen bg-black z-50 flex flex-col items-center justify-center ${
        className || ""
      }`}
    >
      {/* Brand/Logo Section */}
      {/* {showBrand && (
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-heading font-bold text-teal-500 tracking-wide">
            KICKOFF
          </h1>
          <p className="text-sm text-teal-400 text-center mt-1 opacity-80">
      ...
      {showBrand && (
        <div className="mb-2">
          <svg
            ...
            className="h-[100px] md:h-[120px] block mx-auto"
          >
            <svg
              id="Layer_1"
              data-name="Layer 1"
            ...
            >
              <path
                className="animate-pulse-loader [animation-delay:-125ms]"
              ...
              />
              <path
                className="animate-pulse-loader [animation-delay:-250ms]"
                d="M97.55,38.68A43.76,43.76,0,0,1,98,33.44c.41-2.36-.5-3.57-2.57-4.64C91.1,26.59,87,24,82.66,21.82a6.18,6.18,0,0,0-4-.71C73.45,22.55,68.32,24.25,63.22,26c-3.63,1.21-6.08,3.35-5.76,7.69a26.67,26.67,0,0,1-.6,4.92c-1.08,8.06-1.08,8.08,5.86,11.92,3.95,2.19,7.82,5.75,11.94,6.08s8.76-2.41,13.12-3.93c9.33-3.29,9.33-3.3,9.78-14Z"
                fill="#ff6720"
              />
              <path
                className="animate-pulse-loader [animation-delay:-375ms]"
              ...
              />
              <path
                className="animate-pulse-loader [animation-delay:-500ms]"
              ...
              />
              <path
                className="animate-pulse-loader [animation-delay:-625ms]"
              ...
              />
              <path
                className="animate-pulse-loader [animation-delay:-750ms]"
                fill="#ff6720"
              ...
              />
              <path
                className="animate-pulse-loader [animation-delay:-875ms]"
                fill="#ff6720"
              ...
              />
              <path
                className="animate-pulse-loader [animation-delay:-1000ms]"
                fill="#ff6720"
      ...
      <div className="text-center">
        <p className="text-dark-200 font-heading uppercase tracking-wider text-base font-semibold mb-4">
          {loadingText}
        </p>
