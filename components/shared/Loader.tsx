...
export const Loader = ({
  ...
  return (
    <div
      className={`fixed inset-0 w-full h-screen bg-dark-950 z-50 flex flex-col items-center justify-center ${
        className || ""
      }`}
    >
      {/* Brand/Logo Section */}
      ...
      {showBrand && (
        <div className="mb-2">
          <svg
            ...
            className="h-[100px] md:h-[200px] block mx-auto"
          >
            <svg
              id="Layer_1"
              data-name="Layer 1"
      ...
      <div className="text-center">
        <p className="text-gray-400 text-sm font-medium mb-4">{loadingText}</p>
